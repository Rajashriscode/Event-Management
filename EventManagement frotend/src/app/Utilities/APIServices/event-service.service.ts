...
export class EventServiceService {
  ...
  BASE_URL:string="http://localhost:8085/event";
  ...
  {
    return this._httpClient.get(this.BASE_URL+"/getEvent/"+eventId);
  }

  updateEvent(eventId:number, body: any){
    return this._httpClient.put(this.BASE_URL+"/updateEvent/"+eventId, body);
  }
  ...
  getEventOrganizedByOrganizer(organizerId:Number){
    return this._httpClient.get(this.BASE_URL+"/getEventByOrganizer/"+organizerId);
  }
